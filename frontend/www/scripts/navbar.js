    ...
    connectedCallback() {
        ...
        <div class="container-fluid">
            ...
            <div class="my-2 my-lg-0 me-5">
                ...
                <a role="button" class="btn btn-secondary" id="btn-login-nav" href="login.html">Log in</a>
                <a role="button" class="btn btn-secondary" id="btn-logout" href="logout.html">Log out</a>
                <a role="button" class="btn btn-secondary" id="btn-logout" href="profile.html">
                <img src="profile.png"/>
                </a>
            </div>
            </div>
